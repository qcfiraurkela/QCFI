        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="social-terminal">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/qcfiraurkela"
                target="_blank"
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/@QCFIRaurkela"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="social-btn"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/qcfiraurkela"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61593895545279"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="social-btn"
